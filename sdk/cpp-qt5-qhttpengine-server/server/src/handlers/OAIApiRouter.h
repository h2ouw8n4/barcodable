...
public:
    ...
    void setOAIProductConversionApiHandler(QSharedPointer<OAIProductConversionApiHandler> handler);
    void setOAIProductLookupApiHandler(QSharedPointer<OAIProductLookupApiHandler> handler);
private:
    ...
    QSharedPointer<OAIProductConversionApiHandler> mOAIProductConversionApiHandler;
    QSharedPointer<OAIProductLookupApiHandler> mOAIProductLookupApiHandler;
protected:
