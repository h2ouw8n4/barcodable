...
OAIProductLookupApiRequest::OAIProductLookupApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIProductLookupApiHandler> hdl) : QObject(s), socket(s), handler(hdl) {
...
void OAIProductLookupApiRequest::getItemByASINRequest(const QString& asinstr){
    ...
    connect(this, &OAIProductLookupApiRequest::getItemByASIN, handler.data(), &OAIProductLookupApiHandler::getItemByASIN);
...
void OAIProductLookupApiRequest::getItemByEANRequest(const QString& eanstr){
    ...
    connect(this, &OAIProductLookupApiRequest::getItemByEAN, handler.data(), &OAIProductLookupApiHandler::getItemByEAN);
...
void OAIProductLookupApiRequest::getItemByUPCRequest(const QString& upcstr){
    ...
    connect(this, &OAIProductLookupApiRequest::getItemByUPC, handler.data(), &OAIProductLookupApiHandler::getItemByUPC);
