...
void OAIInline_response_200::fromJsonObject(QJsonObject json) {
    ...
    m_asins_isSet = !json[QString("asins")].isNull() && m_asins_isValid;
...
QList<QString> OAIInline_response_200::getUpcs() const {
    return upcs;
}
void OAIInline_response_200::setUpcs(const QList<QString> &upcs) {
    this->upcs = upcs;
    this->m_upcs_isSet = true;
}

QList<QString> OAIInline_response_200::getEans() const {
    return eans;
}
void OAIInline_response_200::setEans(const QList<QString> &eans) {
    this->eans = eans;
    this->m_eans_isSet = true;
}

QList<QString> OAIInline_response_200::getAsins() const {
    return asins;
}
void OAIInline_response_200::setAsins(const QList<QString> &asins) {
    this->asins = asins;
    this->m_asins_isSet = true;
}

QString OAIInline_response_200::getMessage() const {
    return message;
}
void OAIInline_response_200::setMessage(const QString &message) {
