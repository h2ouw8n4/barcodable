...
import org.openapitools.vertxweb.server.api.ProductConversionApiHandler;
import org.openapitools.vertxweb.server.api.ProductLookupApiHandler;
...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> fut) {
        ...
        new ProductConversionApiHandler(operationHandlers);
        new ProductLookupApiHandler(operationHandlers);
