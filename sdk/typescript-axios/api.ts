...
export const ProductConversionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        convertCode(upcEanAsin: string, options?: any): AxiosPromise<InlineResponse200> {
...
export const ProductLookupApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getItemByASIN(asin: string, options?: any): AxiosPromise<Item> {
         ...
         * @throws {RequiredError}
         */
        getItemByEAN(ean: string, options?: any): AxiosPromise<Item> {
         ...
         * @throws {RequiredError}
         */
        getItemByUPC(upc: string, options?: any): AxiosPromise<Item> {
