...
class InlineResponse200(Model):
    ...
    def __init__(self, upcs: List[str]=None, eans: List[str]=None, asins: List[str]=None, message: str=None):  # noqa: E501
