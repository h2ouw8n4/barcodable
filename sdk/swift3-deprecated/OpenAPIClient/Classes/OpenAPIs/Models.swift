    ...
    private static var __once: () = {
        ...
        Decoders.addDecoder(clazz: InlineResponse200.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<InlineResponse200> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                ...
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["upcs"] as AnyObject?) {
                
                case let .success(value): _result.upcs = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["eans"] as AnyObject?) {
                
                case let .success(value): _result.eans = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["asins"] as AnyObject?) {
                
                case let .success(value): _result.asins = value
                case let .failure(error): break
        ...
        Decoders.addDecoder(clazz: [InvalidCode].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[InvalidCode]> in
        ...
        Decoders.addDecoder(clazz: InvalidCode.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<InvalidCode> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? InvalidCode() : instance as! InvalidCode
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["message"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "InvalidCode", actual: "\(source)"))
            }
        }
        // Decoder for [Item]
        ...
        Decoders.addDecoder(clazz: Item.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<Item> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? Item() : instance as! Item
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["asin"] as AnyObject?) {
                
                case let .success(value): _result.asin = value
                case let .failure(error): break
                ...
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["part_number"] as AnyObject?) {
                ...
                case let .success(value): _result.newPrice = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["used_price"] as AnyObject?) {
                
                case let .success(value): _result.usedPrice = value
                case let .failure(error): break
                ...
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["features"] as AnyObject?) {
                
                case let .success(value): _result.features = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: [Any].self, source: sourceDictionary["dimensions"] as AnyObject?) {
                
                case let .success(value): _result.dimensions = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["images"] as AnyObject?) {
                
                case let .success(value): _result.images = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: [Any].self, source: sourceDictionary["matched_items"] as AnyObject?) {
                
                case let .success(value): _result.matchedItems = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["iso_country_codes"] as AnyObject?) {
                
                case let .success(value): _result.isoCountryCodes = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["company_name"] as AnyObject?) {
                
                case let .success(value): _result.companyName = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["company_address"] as AnyObject?) {
                
                case let .success(value): _result.companyAddress = value
                case let .failure(error): break
                ...
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["category_hierarchies"] as AnyObject?) {
                
                case let .success(value): _result.categoryHierarchies = value
                case let .failure(error): break
        ...
        Decoders.addDecoder(clazz: [NotFound].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[NotFound]> in
        ...
        Decoders.addDecoder(clazz: NotFound.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<NotFound> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? NotFound() : instance as! NotFound
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["message"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "NotFound", actual: "\(source)"))
            }
        }
    }()
