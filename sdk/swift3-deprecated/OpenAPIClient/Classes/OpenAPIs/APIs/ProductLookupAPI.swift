...
open class ProductLookupAPI: APIBase {
    /**
     Find item by asin code
     - parameter asin: (path) ASIN code of item to return 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getItemByASIN(asin: String, completion: @escaping ((_ data: Item?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getItemByEAN(ean: String, completion: @escaping ((_ data: Item?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getItemByUPC(upc: String, completion: @escaping ((_ data: Item?, _ error: ErrorResponse?) -> Void)) {
