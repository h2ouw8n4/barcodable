...
MyApp.add_route('GET', '/mindviser/barcodable/1.0.0/api/v1/asin/{asin}', {
...
MyApp.add_route('GET', '/mindviser/barcodable/1.0.0/api/v1/ean/{ean}', {
  "resourcePath" => "/ProductLookup",
...
MyApp.add_route('GET', '/mindviser/barcodable/1.0.0/api/v1/upc/{upc}', {
  "resourcePath" => "/ProductLookup",
  "summary" => "Find item by UPC code",
