...
public:
    ...
    void setDimensions(std::vector<Object> const& value);
    ...
    void setMatchedItems(std::vector<Object> const& value);
    ...
    void setIsoCountryCodes(std::vector<std::string> const& value);
    ...
    void setCategories(std::vector<std::string> const& value);
    ...
    void setCategoryHierarchies(std::vector<std::string> const& value);
    bool categoryHierarchiesIsSet() const;
    void unsetCategory_hierarchies();

    friend void to_json(nlohmann::json& j, const Item& o);
    friend void from_json(const nlohmann::json& j, Item& o);
protected:
    std::string m_Upc;
    bool m_UpcIsSet;
    std::string m_Ean;
