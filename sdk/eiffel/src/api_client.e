...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {API_KEY_AUTH}.make ("header", "Authorization"), "ApiKeyAuth") 
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://virtserver.swaggerhub.com/magicCashew/barcodable/1.0.0"
			-- default base path.
