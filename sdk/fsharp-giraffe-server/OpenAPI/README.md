...
- model/NotFoundModel.fs
- model/ItemModel.fs
- model/InvalidCodeModel.fs
- model/InlineResponse400Model.fs
...
- api/ProductConversionApiHandlerParams.fs
- api/ProductLookupApiHandlerParams.fs
...
- api/ProductConversionApiServiceInterface.fs
- api/ProductLookupApiServiceInterface.fs
...
- impl/ProductConversionApiService.fs
- impl/ProductLookupApiService.fs
