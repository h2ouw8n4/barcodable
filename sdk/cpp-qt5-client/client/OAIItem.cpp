...
void OAIItem::fromJsonObject(QJsonObject json) {
    ...
    m_upcs_isSet = !json[QString("upcs")].isNull() && m_upcs_isValid;
    ...
    m_new_price_isSet = !json[QString("new_price")].isNull() && m_new_price_isValid;

    m_used_price_isValid = ::OpenAPI::fromJsonValue(used_price, json[QString("used_price")]);
    m_used_price_isSet = !json[QString("used_price")].isNull() && m_used_price_isValid;
    ...
    m_matched_items_isSet = !json[QString("matched_items")].isNull() && m_matched_items_isValid;

    m_iso_country_codes_isValid = ::OpenAPI::fromJsonValue(iso_country_codes, json[QString("iso_country_codes")]);
    m_iso_country_codes_isSet = !json[QString("iso_country_codes")].isNull() && m_iso_country_codes_isValid;
    ...
    m_category_hierarchies_isSet = !json[QString("category_hierarchies")].isNull() && m_category_hierarchies_isValid;
}
...
QString OAIItem::getUpc() const {
    return upc;
}
void OAIItem::setUpc(const QString &upc) {
    this->upc = upc;
...
QString OAIItem::getIsbn() const {
    return isbn;
}
void OAIItem::setIsbn(const QString &isbn) {
    this->isbn = isbn;
    this->m_isbn_isSet = true;
}

QString OAIItem::getAsin() const {
    return asin;
}
void OAIItem::setAsin(const QString &asin) {
    this->asin = asin;
...
QString OAIItem::getPartNumber() const {
    return part_number;
}
void OAIItem::setPartNumber(const QString &part_number) {
    this->part_number = part_number;
    this->m_part_number_isSet = true;
}

QList<QString> OAIItem::getUpcs() const {
    return upcs;
}
void OAIItem::setUpcs(const QList<QString> &upcs) {
    this->upcs = upcs;
...
QString OAIItem::getManufacturer() const {
    return manufacturer;
}
void OAIItem::setManufacturer(const QString &manufacturer) {
...
double OAIItem::getNewPrice() const {
    return new_price;
}
void OAIItem::setNewPrice(const double &new_price) {
    this->new_price = new_price;
    this->m_new_price_isSet = true;
}

double OAIItem::getUsedPrice() const {
    return used_price;
}
void OAIItem::setUsedPrice(const double &used_price) {
    this->used_price = used_price;
    this->m_used_price_isSet = true;
}

QString OAIItem::getCurrencyCode() const {
    return currency_code;
}
void OAIItem::setCurrencyCode(const QString &currency_code) {
    this->currency_code = currency_code;
    this->m_currency_code_isSet = true;
}

QString OAIItem::getUrl() const {
    return url;
}
void OAIItem::setUrl(const QString &url) {
    this->url = url;
    this->m_url_isSet = true;
}

QList<QString> OAIItem::getFeatures() const {
    return features;
}
void OAIItem::setFeatures(const QList<QString> &features) {
    this->features = features;
    this->m_features_isSet = true;
}

QList<OAIObject> OAIItem::getDimensions() const {
    return dimensions;
}
void OAIItem::setDimensions(const QList<OAIObject> &dimensions) {
    this->dimensions = dimensions;
    this->m_dimensions_isSet = true;
}

QList<QString> OAIItem::getImages() const {
    return images;
}
void OAIItem::setImages(const QList<QString> &images) {
    this->images = images;
    this->m_images_isSet = true;
}

QList<OAIObject> OAIItem::getMatchedItems() const {
    return matched_items;
}
void OAIItem::setMatchedItems(const QList<OAIObject> &matched_items) {
    this->matched_items = matched_items;
    this->m_matched_items_isSet = true;
}

QList<QString> OAIItem::getIsoCountryCodes() const {
    return iso_country_codes;
}
void OAIItem::setIsoCountryCodes(const QList<QString> &iso_country_codes) {
    this->iso_country_codes = iso_country_codes;
    this->m_iso_country_codes_isSet = true;
}

QString OAIItem::getCompanyName() const {
    return company_name;
}
void OAIItem::setCompanyName(const QString &company_name) {
    this->company_name = company_name;
    this->m_company_name_isSet = true;
}

QString OAIItem::getCompanyAddress() const {
    return company_address;
}
void OAIItem::setCompanyAddress(const QString &company_address) {
    this->company_address = company_address;
    this->m_company_address_isSet = true;
}

QList<QString> OAIItem::getCategories() const {
    return categories;
}
void OAIItem::setCategories(const QList<QString> &categories) {
    this->categories = categories;
    this->m_categories_isSet = true;
}

QList<QString> OAIItem::getCategoryHierarchies() const {
    return category_hierarchies;
}
void OAIItem::setCategoryHierarchies(const QList<QString> &category_hierarchies) {
