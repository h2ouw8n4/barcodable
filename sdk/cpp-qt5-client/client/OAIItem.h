...
public:
    ...
    OAINumber getNewPrice() const;
    void setNewPrice(const OAINumber &new_price);

    OAINumber getUsedPrice() const;
    void setUsedPrice(const OAINumber &used_price);
