...
object ProductLookupApi {
  ...
  def getItemByASIN(asin: String): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, "https://virtserver.swaggerhub.com/magicCashew/barcodable/1.0.0", "/api/v1/asin/{asin}", "application/json")
  ...
  def getItemByEAN(ean: String): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, "https://virtserver.swaggerhub.com/magicCashew/barcodable/1.0.0", "/api/v1/ean/{ean}", "application/json")
  ...
  def getItemByUPC(upc: String): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, "https://virtserver.swaggerhub.com/magicCashew/barcodable/1.0.0", "/api/v1/upc/{upc}", "application/json")
