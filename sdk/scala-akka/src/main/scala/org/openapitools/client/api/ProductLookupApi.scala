...
object ProductLookupApi {
  ...
  def apply(baseUrl: String = "https://virtserver.swaggerhub.com/magicCashew/barcodable/1.0.0") = new ProductLookupApi(baseUrl)
}

class ProductLookupApi(baseUrl: String) {
   ...
   */
  def getItemByASIN(asin: String): ApiRequest[Item] =
    ApiRequest[Item](ApiMethods.GET, baseUrl, "/api/v1/asin/{asin}", "application/json")
   ...
   */
  def getItemByEAN(ean: String): ApiRequest[Item] =
    ApiRequest[Item](ApiMethods.GET, baseUrl, "/api/v1/ean/{ean}", "application/json")
   ...
   */
  def getItemByUPC(upc: String): ApiRequest[Item] =
    ApiRequest[Item](ApiMethods.GET, baseUrl, "/api/v1/upc/{upc}", "application/json")
