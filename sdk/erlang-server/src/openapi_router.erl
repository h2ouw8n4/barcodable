...
get_operations() ->
    #{ 
        'ConvertCode' => #{
            path => "/mindviser/barcodable/1.0.0/api/v1/convert/:upc | ean | asin",
            method => <<"GET">>,
            handler => 'openapi_product_conversion_handler'
        },
        'GetItemByASIN' => #{
            path => "/mindviser/barcodable/1.0.0/api/v1/asin/:asin",
            method => <<"GET">>,
            handler => 'openapi_product_lookup_handler'
        },
        'GetItemByEAN' => #{
            path => "/mindviser/barcodable/1.0.0/api/v1/ean/:ean",
            method => <<"GET">>,
            handler => 'openapi_product_lookup_handler'
        },
        'GetItemByUPC' => #{
            path => "/mindviser/barcodable/1.0.0/api/v1/upc/:upc",
            method => <<"GET">>,
            handler => 'openapi_product_lookup_handler'
        }
    }.
