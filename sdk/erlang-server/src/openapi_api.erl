...
request_params('ConvertCode') ->
    [
        'upc | ean | asin'
    ];


request_params('GetItemByASIN') ->
    [
        'asin'
    ];

request_params('GetItemByEAN') ->
    [
        'ean'
    ];

request_params('GetItemByUPC') ->
    [
        'upc'
    ];
...
request_param_info('ConvertCode', 'upc | ean | asin') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetItemByASIN', 'asin') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetItemByEAN', 'ean') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetItemByUPC', 'upc') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
validate_response('ConvertCode', 200, Body, ValidatorState) ->
    validate_response_body('inline_response_200', 'inline_response_200', Body, ValidatorState);
validate_response('ConvertCode', 400, Body, ValidatorState) ->
    validate_response_body('inline_response_400', 'inline_response_400', Body, ValidatorState);


validate_response('GetItemByASIN', 200, Body, ValidatorState) ->
    validate_response_body('item', 'item', Body, ValidatorState);
validate_response('GetItemByASIN', 400, Body, ValidatorState) ->
    validate_response_body('invalid_code', 'invalid_code', Body, ValidatorState);
validate_response('GetItemByASIN', 404, Body, ValidatorState) ->
    validate_response_body('not_found', 'not_found', Body, ValidatorState);

validate_response('GetItemByEAN', 200, Body, ValidatorState) ->
    validate_response_body('item', 'item', Body, ValidatorState);
validate_response('GetItemByEAN', 400, Body, ValidatorState) ->
    validate_response_body('invalid_code', 'invalid_code', Body, ValidatorState);
validate_response('GetItemByEAN', 404, Body, ValidatorState) ->
    validate_response_body('not_found', 'not_found', Body, ValidatorState);

validate_response('GetItemByUPC', 200, Body, ValidatorState) ->
    validate_response_body('item', 'item', Body, ValidatorState);
validate_response('GetItemByUPC', 400, Body, ValidatorState) ->
    validate_response_body('invalid_code', 'invalid_code', Body, ValidatorState);
validate_response('GetItemByUPC', 404, Body, ValidatorState) ->
    validate_response_body('not_found', 'not_found', Body, ValidatorState);
