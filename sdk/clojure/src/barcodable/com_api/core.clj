...
(def auth-definitions
  {"ApiKeyAuth" {:type :api-key :in :header :param-name "Authorization"}})

(def default-api-context
  "Default API context."
  {:base-url        "https://virtserver.swaggerhub.com/magicCashew/barcodable/1.0.0"
