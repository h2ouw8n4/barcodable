## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Barcodable.com API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Barcodable.com API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Barcodable.com                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | barcodable.com                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | comConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | comRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Barcodable.com.Client    | use the "dispatch" functions to send requests       |
| Barcodable.com.Core      | core funcions, config and request types             |
| Barcodable.com.API       | construct api requests                              |
| Barcodable.com.Model     | describes api models                                |
| Barcodable.com.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Barcodable.com.ModelLens | lenses for model fields                             |
| Barcodable.com.Logging   | logging functions and utils                         |
