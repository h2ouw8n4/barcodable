...
begin
   ...
   WS.Register_Application ("/magicCashew/barcodable/1.0.0", App'Unchecked_Access);
   App.Dump_Routes (Util.Log.INFO_LEVEL);
   Log.Info ("Connect you browser to: http://localhost:8080/magicCashew/barcodable/1.0.0/ui/index.html");
