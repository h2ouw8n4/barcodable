...
package body .Models is
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in InlineResponse400Type) is
   begin
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in InlineResponse400Type_Vectors.Vector) is
   begin
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out InlineResponse400Type) is
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out InlineResponse400Type_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : InlineResponse400Type;
   begin
      Value.Clear;
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in InvalidCodeType_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out InvalidCodeType_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : InvalidCodeType;
   begin
      Value.Clear;
      Swagger.Streams.Deserialize (From, Name, List);
      for Data of List loop
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in NotFoundType_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out NotFoundType_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : NotFoundType;
   begin
      Value.Clear;
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in ItemType_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   begin
      ...
      Swagger.Streams.Deserialize (Object, "new_price", Value.New_Price);
      Swagger.Streams.Deserialize (Object, "used_price", Value.Used_Price);
      ...
      Swagger.Streams.Deserialize (Object, "matched_items", Value.Matched_Items);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out ItemType_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : ItemType;
   begin
      Value.Clear;
